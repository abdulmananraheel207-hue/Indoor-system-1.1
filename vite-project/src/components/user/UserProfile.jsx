...
const UserProfile = () => {
  ...
  // If guest, show a "Sign up to view profile" message
  if (isGuest) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Your Profile Awaits!</h2>
          <p className="text-gray-600 mb-8">
            Sign up to create your profile, track your bookings, save favorite arenas, and more!
          </p>
          <div className="space-y-3">
            ...
            <button
              onClick={() => navigate("/")}
              className="w-full border border-gray-300 text-gray-700 font-medium py-3 rounded-lg hover:bg-gray-50"
            >
              Back to Home
            </button>
          </div>
