...
const UserProfile = () => {
    ...
    const [favoriteArenas, setFavoriteArenas] = useState([
        { id: 1, name: 'Elite Sports Arena', rating: 4.5, sport: 'Cricket' },
        { id: 2, name: 'Pro Badminton Court', rating: 4.2, sport: 'Badminton' },
        { id: 3, name: 'City Padel Club', rating: 4.8, sport: 'Padel' },
    ]);
    ...
    const handleRemoveFavorite = (arenaId) => {
        setFavoriteArenas(favoriteArenas.filter(arena => arena.id !== arenaId));
    };
        ...
        <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                {activeTab === 'favorites' && (
                    <div className="space-y-6">
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <h2 className="text-lg font-semibold text-gray-900 mb-6">Favorite Arenas</h2>
                            ...
                            {favoriteArenas.length === 0 ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="mt-2 text-sm font-medium text-gray-900">No favorite arenas</h3>
                                    <p className="mt-1 text-sm text-gray-500">Add arenas to your favorites to quickly book them later.</p>
                                </div>
                            ) : (
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {favoriteArenas.map((arena) => (
                                        <div key={arena.id} className="border border-gray-200 rounded-lg p-4">
                                            <div className="flex items-start justify-between mb-3">
                                                <div>
                                                    <h3 className="font-semibold text-gray-900">{arena.name}</h3>
                                                    <div className="flex items-center mt-1">
                                                        <span className="text-sm text-gray-600">{arena.sport}</span>
                                                        <div className="flex items-center ml-3">
                                                            <svg className="h-3 w-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                            </svg>
                                                            <span className="text-sm ml-1">{arena.rating}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button
                                                    onClick={() => handleRemoveFavorite(arena.id)}
