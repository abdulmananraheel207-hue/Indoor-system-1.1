                ...
                <div className="space-y-6">
                    {loading ? (
                        ...
                        bookings.map((booking) => (
                            <div key={booking.booking_id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-900">{booking.arena_name}</h3>
                                        <div className="flex items-center mt-2 space-x-3">
                                            <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded">
                                                {booking.sport_name}
                                            </span>
                                            <span className="text-sm text-gray-600">Court Booking</span>
                                        </div>
                                    </div>
                                ...
                                <div className="flex flex-wrap gap-3">
                                    ...
                                    {activeTab === 'upcoming' && booking.payment_status === 'pending' && (
                                        <button
