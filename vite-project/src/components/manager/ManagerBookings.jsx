// components/manager/ManagerBookings.jsx - UPDATED TO MATCH OWNER BOOKINGS
...
const ManagerBookings = ({ permissions }) => {
        ...
        return (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
                ...
                <p className="text-yellow-600 mt-2">
                    You need view_bookings permission to access this section
                </p>
            </div>
        );
    }
    ...
    }, [statusFilter, dateFrom, dateTo, activeTab]);
    ...
    const fetchBookings = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `http://localhost:5000/api/managers/bookings?${params.toString()}`,
                {
                    headers: {
    ...
    const handleAcceptBooking = async (bookingId) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (canViewFinancial) fetchStats();
            } else {
                const data = await response.json();
    ...
    return (
        <div>
            ...
            {/* Stats Overview - Only if view_financial */}
            {canViewFinancial && (
            ...
            <div className="bg-white rounded-xl shadow mb-6">
                ...
                <div className="p-0">
                    {loading ? (
                        ...
                        <>
                            {/* Desktop Table View - MATCHES OWNER BOOKINGS */}
                                                ...
                                                <td className="px-4 py-3 whitespace-nowrap text-sm font-medium">
                                                    {activeTab === "upcoming" ? (
                                                        <div className="flex flex-col space-y-1 md:flex-row md:space-x-2 md:space-y-0">
                                                            ...
                                                            {canManageBookings && booking.status === "accepted" && (
                                                                <button
                                                                    onClick={() =>
                            ...
                            {/* Mobile Card View - MATCHES OWNER BOOKINGS */}
            ...
            {/* Booking Details Modal - MATCHES OWNER BOOKINGS */}
            {selectedBooking && (
