        ...
        {loginMethod === "email" ? (
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${errors.phone_number ? "border-red-500" : "border-gray-300"
                }`}
