// File: PaymentVerificationModal.jsx - NEW FILE
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-blue-100 text-sm mt-1">
                                    Booking #{booking.booking_id} • {booking.user_name}
                                </p>
                            </div>
                        </div>
                        <button
                                ...
                                {booking.payment_screenshot_url ? (
                                    <div className="space-y-4">
                                        ...
                                        <div
                                            ...
                                            onClick={() => setActiveImage(booking.payment_screenshot_url)}
                                        >
                                            <img
