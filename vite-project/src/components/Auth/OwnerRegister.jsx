...
const OwnerRegister = () => {
  ...
  const validateForm = () => {
    ...
    // Only validate court details on final step (step 3)
    if (activeStep === 3) {
      courtDetails.forEach((court, index) => {
        if (!court.size) {
          newErrors[`court_${index}_size`] = `Court ${index + 1
            } size is required`;
        }
        if (court.pricePerHour <= 0) {
          newErrors[`court_${index}_price`] = `Court ${index + 1
    ...
    <div className="flex justify-center mb-8">
      {[1, 2, 3].map((step) => (
        <div key={step} className="flex items-center">
          <div
            className={`w-10 h-10 rounded-full flex items-center justify-center ${activeStep >= step
          ...
          {step < 3 && (
            <div
              className={`w-20 h-1 ${activeStep > step ? "bg-green-600" : "bg-gray-200"
                }`}
            />
          )}
        </div>
  ...
  const renderPasswordRequirements = () => (
    <div className="mt-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div className={`flex items-center text-sm ${passwordValidation.number ? 'text-green-600' : 'text-red-500'}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 ${errors.confirmPassword
                        ? "border-red-500"
                        : "border-gray-300"
                      }`}
              ...
              {days.map((day) => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm ${timeSlots[day.key].isOpen
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center space-x-4">
                      <input
                        ...
                        className={`w-40 px-4 py-2 border rounded-lg ${errors[`court_${courtIndex}_size`]
                            ? "border-red-500"
                            : "border-gray-300"
                          }`}
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <input
                        ...
                        className={`w-40 px-4 py-2 border rounded-lg ${errors[`court_${courtIndex}_price`]
                            ? "border-red-500"
                            : "border-gray-300"
                          }`}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {sportsOptions.map((sport) => (
                        <button
                          ...
                          className={`px-3 py-1 rounded-full text-sm ${court.sportTypes.includes(sport)
                              ? "bg-green-600 text-white"
          ...
          <div className="flex justify-between pt-6 border-t">
            ...
            <button
              ...
              onClick={activeStep < 3 ? handleNextStep : undefined}
              disabled={loading}
